...
// End Cross Module References
	...
	UFunction* Z_Construct_UFunction_UVRButtonComponent_IsValidOverlap()
	{
		...
		if (!ReturnFunction)
		{
			auto NewProp_ReturnValue_SetBit = [](void* Obj){ ((VRButtonComponent_eventIsValidOverlap_Parms*)Obj)->ReturnValue = 1; };
			static const UE4CodeGen_Private::FBoolPropertyParams NewProp_ReturnValue = { UE4CodeGen_Private::EPropertyClass::Bool, "ReturnValue", RF_Public|RF_Transient|RF_MarkAsNative, 0x0010000000000580, 1, nullptr, sizeof(bool), UE4CodeGen_Private::ENativeBool::Native, sizeof(VRButtonComponent_eventIsValidOverlap_Parms), &UE4CodeGen_Private::TBoolSetBitWrapper<decltype(NewProp_ReturnValue_SetBit)>::SetBit, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
			static const UE4CodeGen_Private::FMetaDataPairParam NewProp_OverlapComponent_MetaData[] = {
				{ "EditInline", "true" },
			};
#endif
			static const UE4CodeGen_Private::FObjectPropertyParams NewProp_OverlapComponent = { UE4CodeGen_Private::EPropertyClass::Object, "OverlapComponent", RF_Public|RF_Transient|RF_MarkAsNative, 0x0010000000080080, 1, nullptr, STRUCT_OFFSET(VRButtonComponent_eventIsValidOverlap_Parms, OverlapComponent), Z_Construct_UClass_UPrimitiveComponent_NoRegister, METADATA_PARAMS(NewProp_OverlapComponent_MetaData, ARRAY_COUNT(NewProp_OverlapComponent_MetaData)) };
			static const UE4CodeGen_Private::FPropertyParamsBase* const PropPointers[] = {
				(const UE4CodeGen_Private::FPropertyParamsBase*)&NewProp_ReturnValue,
...
#endif
			static const UE4CodeGen_Private::FFunctionParams FuncParams = { (UObject*(*)())Z_Construct_UClass_UVRButtonComponent, "IsValidOverlap", RF_Public|RF_Transient|RF_MarkAsNative, nullptr, (EFunctionFlags)0x0C020C00, sizeof(VRButtonComponent_eventIsValidOverlap_Parms), PropPointers, ARRAY_COUNT(PropPointers), 0, 0, METADATA_PARAMS(Function_MetaDataParams, ARRAY_COUNT(Function_MetaDataParams)) };
			UE4CodeGen_Private::ConstructUFunction(ReturnFunction, FuncParams);
		}
		return ReturnFunction;
	}
	...
	UClass* Z_Construct_UClass_UVRButtonComponent()
	{
		...
		if (!OuterClass)
		{
			...
			static const FClassFunctionLinkInfo FuncInfo[] = {
				...
				{ &Z_Construct_UFunction_UVRButtonComponent_IsValidOverlap, "IsValidOverlap" }, // 1658015749
...
#endif
			auto NewProp_bSkipOverlapFiltering_SetBit = [](void* Obj){ ((UVRButtonComponent*)Obj)->bSkipOverlapFiltering = 1; };
			static const UE4CodeGen_Private::FBoolPropertyParams NewProp_bSkipOverlapFiltering = { UE4CodeGen_Private::EPropertyClass::Bool, "bSkipOverlapFiltering", RF_Public|RF_Transient|RF_MarkAsNative, 0x0010000000000005, 1, nullptr, sizeof(bool), UE4CodeGen_Private::ENativeBool::Native, sizeof(UVRButtonComponent), &UE4CodeGen_Private::TBoolSetBitWrapper<decltype(NewProp_bSkipOverlapFiltering_SetBit)>::SetBit, METADATA_PARAMS(NewProp_bSkipOverlapFiltering_MetaData, ARRAY_COUNT(NewProp_bSkipOverlapFiltering_MetaData)) };
#if WITH_METADATA
			...
			static const UE4CodeGen_Private::FPropertyParamsBase* const PropPointers[] = {
				(const UE4CodeGen_Private::FPropertyParamsBase*)&NewProp_bSkipOverlapFiltering,
	...
	IMPLEMENT_CLASS(UVRButtonComponent, 322334946);
